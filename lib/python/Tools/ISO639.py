# Embedded file name: /usr/lib/enigma2/python/Tools/ISO639.py
LanguageCodes = {}
...
LanguageCodes['nob'] = LanguageCodes['nb'] = ('Norwegian Bokm\xe5l', '')
...
LanguageCodes['oci'] = LanguageCodes['oc'] = ('Occitan (post 1500); Proven\xe7al', 'Romance')
...
LanguageCodes['pro'] = ('Proven\xe7al, Old (to 1500)', '')
...
LanguageCodes['vol'] = LanguageCodes['vo'] = ('Volap\xfck', 'International aux.')
