# Embedded file name: /usr/lib/enigma2/python/Components/AVSwitch.py
...
class AVSwitch():
    ...
    if about.getChipSetString() in ('7366', '7376', '5272s'):
        ...
        widescreen_modes = {'720p',
         ...
         '1080i',
         '2160p'}
    elif about.getChipSetString() in ('7241',
     '7358',
     '7362',
     '7346',
     '7356',
    ...
    if modes.has_key('YPbPr') and getBoxType() in ('zgemmah5',
     'zgemmai55',
     'sf98',
     'odinplus',
     'zgemmaslc',
     ...
     'vizyonvita',
     'wetekplay',
     'wetekplayplus') or about.getModelString() == 'ini-3000':
        del modes['YPbPr']
    if modes.has_key('Scart') and getBoxType() in ('tmnano',
     'tmnano3t',
     'tmnano2super',
     'formuler3',
     'enibox',
     ...
     'mbhybrid'):
        ...
        del modes['Scart']
    if modes.has_key('Scart') and getBoxType() in ('vusolo4k',
     'fusionhdse',
     'fusionhd',
     'wetekplay',
     'wetekplayplus',
