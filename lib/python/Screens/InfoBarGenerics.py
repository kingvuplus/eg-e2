...
from enigma import eTimer, eServiceCenter, eDVBServicePMTHandler, iServiceInformation, iPlayableService, eServiceReference, eEPGCache, eActionMap, quitMainloop
...
class InfoBarResolutionSelection():
    ...
    def resolutionSelection(self):
        ...
        tlist.append(('720p@60hz', '720p'))
        tlist.append(('1080i@50hz', '1080i50'))
        tlist.append(('1080i@60hz', '1080i'))
        tlist.append(('1080p@50hz', '1080p50'))
        tlist.append(('1080p@60hz', '1080p'))
        keys = ['green',
         'yellow',
         'blue',
         '',
