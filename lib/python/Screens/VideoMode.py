# Embedded file name: /usr/lib/enigma2/python/Screens/VideoMode.py
from os import path
    ...
    def createSetup(self):
        ...
        if level >= 1:
            ...
            if SystemInfo['CanChangeOsdAlpha']:
                self.list.append(getConfigListEntry(_('OSD transparency'), config.av.osd_alpha2, _('Configure the transparency of the OSD.')))
