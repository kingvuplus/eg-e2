# Embedded file name: /usr/lib/enigma2/python/Screens/PiPSetup.py
...
class PiPSetup(Screen):
    skin = '<screen name="PiPSetup" position="center,center" size="600,150" backgroundColor="transparent" flags="wfNoBorder">\n\t\t<widget name="text" position="0,0" size="600,150" font="Regular;23"/>\n\t</screen>'
