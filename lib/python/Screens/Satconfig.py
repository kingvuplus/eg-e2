# Embedded file name: /usr/lib/enigma2/python/Screens/Satconfig.py
...
class NimSetup(Screen, ConfigListScreen, ServiceStopScreen):
    ...
    def keySave(self):
        if not self.unicableconnection():
            ...
            return
        elif not self.checkLoopthrough():
...
class NimSelection(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['SetupActions', 'ColorActions', 'MenuActions'], {'ok': self.okbuttonClick,
         'cancel': self.close,
         'red': self.close,
