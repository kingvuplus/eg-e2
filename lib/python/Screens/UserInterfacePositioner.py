# Embedded file name: /usr/lib/enigma2/python/Screens/UserInterfacePositioner.py
...
def InitOsd():
    ...
    print '[UserInterfacePositioner] Setting OSD position: %s %s %s %s' % (config.osd.dst_left.value,
