# Embedded file name: /usr/lib/enigma2/python/Screens/VideoWizard.py
...
class VideoWizard(WizardLanguage, Rc):
    ...
    def showTestCard(self, selection = None):
        ...
        print '[VideoWizard] set config.misc.showtestcard to', {'yes': True,
         'no': False}[selection]
        if selection == 'yes':
