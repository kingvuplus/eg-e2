# Embedded file name: /usr/lib/enigma2/python/Screens/ButtonSetup.py
...
ButtonSetupKeys = [(_('Red'), 'red', 'Infobar/openSingleServiceEPG'),
 ...
 (_('Green'), 'green', 'Module/EGAMI.EGAMI_Green/EGGreenPanel'),
 ...
 (_('Blue'), 'blue', 'Module/EGAMI.EGAMI_Blue/EmuManager'),
 ...
 (_('F3'), 'f3', ''),
 (_('F3 long'), 'f3_long', ''),
 (_('F4'), 'f4', 'Module/EGAMI.EGAMI_Green/EGGreenPanel'),
 (_('F4 long'), 'f4_long', '')]
