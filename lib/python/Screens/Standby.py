# Embedded file name: /usr/lib/enigma2/python/Screens/Standby.py
    ...
    def __onClose(self):
        ...
        if self.paused_service:
            ...
            if config.servicelist.startupservice_onstandby.value:
                self.session.nav.playService(eServiceReference(config.servicelist.startupservice_standby.value))
                from Screens.InfoBar import InfoBar
