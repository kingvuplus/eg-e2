# Embedded file name: /usr/lib/enigma2/python/Screens/TimeDateInput.py
...
class TimeDateInput(Screen, ConfigListScreen):
    ...
    def __init__(self, session, config_time = None, config_date = None):
        ...
        self['actions'] = NumberActionMap(['SetupActions'], {'ok': self.keySelect,
         'save': self.keyGo,
    ...
    def createSetup(self, configlist):
        self.list = [getConfigListEntry(_('Date'), self.timeinput_date), getConfigListEntry(_('Time'), self.timeinput_time)]
